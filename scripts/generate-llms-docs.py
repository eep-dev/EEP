...
def build_llms_txt() -> str:
    ...
    lines = [
        ...
        "- TS packages: packages/@eep-dev/* (@eep-dev/signer, validator, gates, middleware, mcp-bridge, discovery, compliance-cli, setup-cli, agent-adopt)",
        ...
        "- how-to-subscribe.md: subscribe to an entity's events (core agent action)",
        "- how-to-dispatch.md: dispatch/publish events as a provider (core agent action)",
...
def build_llms_full() -> str:
    ...
    lines = [
        ...
        "",
        "=== FILE: EEP/docs/guides/how-to-subscribe.md ===",
        (DOCS_ROOT / "guides/how-to-subscribe.md").read_text(encoding="utf-8"),
        "",
        "=== FILE: EEP/docs/guides/how-to-dispatch.md ===",
        (DOCS_ROOT / "guides/how-to-dispatch.md").read_text(encoding="utf-8"),
        "",
